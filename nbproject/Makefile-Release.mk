...
${OBJECTDIR}/src/Client.o: src/Client.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/cpprest -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Client.o src/Client.cpp

${OBJECTDIR}/src/Response.o: src/Response.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/cpprest -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Response.o src/Response.cpp

${OBJECTDIR}/src/Value.o: src/Value.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/cpprest -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Value.o src/Value.cpp

${OBJECTDIR}/src/json_constants.o: src/json_constants.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/cpprest -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/json_constants.o src/json_constants.cpp
